/*
SIMULATION OF A SOFT BODY USING MASS-SPRING MODEL (CONTINUOUS BODY MODELLED AS A SERIES OF MASSES ATTACHED
TO EACH OTHER WITH HOOKE SPRINGS WITH DAMPING FACTORS. MOTION CALCULATED USING BASIC FORWARD EULER METHOD.
*/
